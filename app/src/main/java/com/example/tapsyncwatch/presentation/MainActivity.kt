...
// visual tuning (commit on slider release)
                        ringScale = s.ringScale,
                        ringThickness = s.ringThickness,
                        ringAlpha = s.ringAlpha,
                        downbeatSize = s.downbeatSize,
                        downbeatAlpha = s.downbeatAlpha,
                        ghostAlpha = s.ghostAlpha,
                        ghostThickness = s.ghostThickness,
                        lockGlow = s.lockGlow,
                        spiralStrength = s.spiralStrength,
                        spiralAlpha = s.spiralAlpha,
                        animationIntensity = s.animationIntensity,
                        rippleStrength = s.rippleStrength,
                        pulseStrength = s.pulseStrength,
